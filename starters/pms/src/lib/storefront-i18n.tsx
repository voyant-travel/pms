...
export const storefrontMessagesEn = {
  ...
  staySearch: {
    ...
    intro: "Search our properties by destination, dates and occupancy.",
    ...
    rooms: "Rooms",
    search: "Search",
    resultsHeading: "Properties",
    resultsCount: "{count} properties",
    noResults: "No properties match your search. Try different dates or another destination.",
    unavailableTitle: "Property search isn't configured",
    unavailableBody:
      "The search index is offline (typically because TYPESENSE_HOST isn't set). Open a property directly from the operator dashboard to demo the booking flow.",
  ...
  shopDetailAccommodations: {
    ...
    roomSize: "{size} m²",
    freeLabel: "Free",
    noRooms: "No rooms are configured for this property yet.",
    yourStay: "Your stay",
    nightsSummary: "{nights} nights · {guests} guests",
  },
  shopDetailCruises: {
    occupancy: "Occupancy",
  ...
  manageBooking: {
    ...
    // Find-my-booking form
    eyebrow: "Your reservation",
    findTitle: "Find your booking",
    findIntro:
      "Enter your booking reference and the email on the reservation to view your stay and manage it.",
    referenceLabel: "Booking reference",
    referencePlaceholder: "STAY-000000-XXXXXX",
    emailLabel: "Email address",
    emailPlaceholder: "you@example.com",
    lookupCta: "Find my booking",
    lookingUp: "Looking up…",
    referenceRequired: "Enter your booking reference.",
    emailRequired: "Enter the email on your booking.",
    emailInvalid: "Enter a valid email address.",
    notFound: "We couldn't find a booking with that reference and email. Check both and try again.",
    lookupError: "Something went wrong looking up your booking. Please try again in a moment.",
    backToLookup: "Look up a different booking",
    // Status timeline
    timelineTitle: "Booking status",
    statusConfirmed: "Confirmed",
    statusUpcoming: "Upcoming",
    statusInHouse: "In-house",
    statusCompleted: "Completed",
    statusCancelled: "Cancelled",
    // Stay summary (shared with the confirmation page)
    stayTitle: "Your stay",
    detailsHeading: "Reservation details",
    checkIn: "Check-in",
    checkOut: "Check-out",
    nightsOne: "1 night",
    nightsOther: "{count} nights",
    guests: "Guests",
    adultsOne: "1 adult",
    adultsOther: "{count} adults",
    childrenOne: "1 child",
    childrenOther: "{count} children",
    infantsOne: "1 infant",
    infantsOther: "{count} infants",
    ...
    // What's next / property contact
    whatsNextTitle: "What's next",
    checkInFrom: "Check-in from {time} on your arrival day.",
    checkOutBy: "Check-out by {time} on your departure day.",
    propertyContactTitle: "Contact the property",
    changesTitle: "Need to change or cancel?",
    changesBody:
      "To amend dates or guests, or to cancel this reservation, please contact the property directly and quote your booking reference — our team will take care of the rest.",
    cancellationTitle: "Cancellation policy",
    cancellationRefundable:
      "This rate is flexible — contact the property to change or cancel your stay.",
    cancellationNonRefundable:
      "This rate is non-refundable. Contact the property if your plans change and we'll do our best to help.",
    print: "Print",
    addToCalendar: "Add to calendar",
    // Confirmation → manage handoff
    findLaterTitle: "Keep your booking reference",
    findLaterBody:
      "You can view or manage this reservation any time — just head to Manage booking and enter your reference and email.",
    manageCta: "Manage this booking",
  },
}
...
export const storefrontMessagesRo: StorefrontMessages = {
  ...
  staySearch: {
    heading: "Gaseste-ti sejurul",
    intro: "Cauta proprietatile noastre dupa destinatie, date si ocupare.",
    destinationLabel: "Destinatie",
    destinationPlaceholder: "Unde calatoresti?",
    checkIn: "Check-in",
    checkOut: "Check-out",
    adults: "Adulti",
    children: "Copii",
    rooms: "Camere",
    search: "Cauta",
    resultsHeading: "Proprietati",
    resultsCount: "{count} proprietati",
    noResults: "Nicio proprietate nu corespunde cautarii. Incearca alte date sau alta destinatie.",
    unavailableTitle: "Cautarea proprietatilor nu este configurata",
    unavailableBody:
      "Indexul de cautare este offline (de obicei pentru ca TYPESENSE_HOST nu este setat). Deschide o proprietate direct din panoul operatorului pentru a testa fluxul de rezervare.",
    fromPerNight: "de la {amount} / noapte",
    fromLabel: "de la {amount}",
    viewProperty: "Vezi proprietatea",
    invalidDates: "Check-out trebuie sa fie dupa check-in.",
  },
  shopDetailShared: {
  ...
  shopDetailAccommodations: {
    ...
    roomSize: "{size} m²",
    freeLabel: "Gratuit",
    noRooms: "Nicio camera nu este inca configurata pentru aceasta proprietate.",
    yourStay: "Sejurul tau",
    nightsSummary: "{nights} nopti · {guests} oaspeti",
  },
  shopDetailCruises: {
    occupancy: "Ocupare",
  ...
  manageBooking: {
    navLabel: "Gestioneaza rezervarea",
    eyebrow: "Rezervarea ta",
    findTitle: "Gaseste-ti rezervarea",
    findIntro:
      "Introdu numarul rezervarii si emailul de pe rezervare pentru a-ti vedea si gestiona sejurul.",
    referenceLabel: "Numar rezervare",
    referencePlaceholder: "STAY-000000-XXXXXX",
    emailLabel: "Adresa de email",
    emailPlaceholder: "tu@example.com",
    lookupCta: "Gaseste rezervarea",
    lookingUp: "Se cauta…",
    referenceRequired: "Introdu numarul rezervarii.",
    emailRequired: "Introdu emailul de pe rezervare.",
    emailInvalid: "Introdu o adresa de email valida.",
    notFound:
      "Nu am gasit o rezervare cu acel numar si email. Verifica ambele si incearca din nou.",
    lookupError: "A aparut o eroare la cautarea rezervarii. Incearca din nou peste un moment.",
    backToLookup: "Cauta alta rezervare",
    timelineTitle: "Statusul rezervarii",
    statusConfirmed: "Confirmata",
    statusUpcoming: "Urmatoare",
    statusInHouse: "In sejur",
    statusCompleted: "Finalizata",
    statusCancelled: "Anulata",
    stayTitle: "Sejurul tau",
    detailsHeading: "Detalii rezervare",
    checkIn: "Check-in",
    checkOut: "Check-out",
    nightsOne: "1 noapte",
    nightsOther: "{count} nopti",
    guests: "Oaspeti",
    adultsOne: "1 adult",
    adultsOther: "{count} adulti",
    childrenOne: "1 copil",
    childrenOther: "{count} copii",
    infantsOne: "1 bebelus",
    infantsOther: "{count} bebelusi",
    roomLabel: "Camera {index}",
    roomType: "Camera",
    ratePlan: "Tarif",
    board: "Masa",
    rateBreakdownTitle: "Detaliere tarif",
    total: "Total",
    paymentStatusLabel: "Plata",
    paid: "Platit",
    paymentPending: "In asteptare",
    invoiceNumber: "Numar factura",
    guestDetailsTitle: "Detalii oaspete",
    leadGuest: "Oaspete principal",
    whatsNextTitle: "Ce urmeaza",
    checkInFrom: "Check-in de la ora {time} in ziua sosirii.",
    checkOutBy: "Check-out pana la ora {time} in ziua plecarii.",
    propertyContactTitle: "Contacteaza proprietatea",
    changesTitle: "Vrei sa modifici sau sa anulezi?",
    changesBody:
      "Pentru a modifica datele sau oaspetii, ori pentru a anula rezervarea, contacteaza direct proprietatea si mentioneaza numarul rezervarii — echipa noastra se ocupa de rest.",
    cancellationTitle: "Politica de anulare",
    cancellationRefundable:
      "Acest tarif este flexibil — contacteaza proprietatea pentru a modifica sau anula sejurul.",
    cancellationNonRefundable:
      "Acest tarif este nerambursabil. Contacteaza proprietatea daca planurile se schimba si vom face tot posibilul sa te ajutam.",
    print: "Tipareste",
    addToCalendar: "Adauga in calendar",
    findLaterTitle: "Pastreaza numarul rezervarii",
    findLaterBody:
      "Poti vedea sau gestiona rezervarea oricand — mergi la Gestioneaza rezervarea si introdu numarul si emailul.",
    manageCta: "Gestioneaza rezervarea",
  },
}
